...
@EntityRef(type = DocumentContext.class)
public class DocumentContextResponse extends MappedResponse<DocumentContext> {
    public DocumentContextResponse(Map<String, Object> source) {
        super(source);
    }
}
