...
public class RuleEvaluationMetrics extends MetricsBase {
    ...
    public RuleEvaluationMetrics(@NonNull String engine,
                                 @NonNull String name,
    ...
    public DistributionSummary timer(@NonNull Class<? extends Rule<?>> type) {
        return addTimer(type.getCanonicalName(), null);
    }
}
