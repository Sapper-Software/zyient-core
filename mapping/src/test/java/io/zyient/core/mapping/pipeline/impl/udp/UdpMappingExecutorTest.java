...
class UdpMappingExecutorTest {
    private static final String __CONFIG_FILE = "src/test/resources/mapping/udp/test-udp-env.xml";
    private static final String __CONFIG_FILE_MAPPING = "src/test/resources/mapping/udp/udp-mapping.xml";
    private static final String __INPUT_UDP_JSON = "src/test/resources/data/sample_udp.json";
    ...
    void read() {
        try {
            File input = new File(__INPUT_UDP_JSON);
