...
public class CustomersEntity implements IEntity<IntegerKey> {
    ...
    @Basic
    @jakarta.persistence.Column(name = "customerName")
    private String customerName;
    @Basic
    @jakarta.persistence.Column(name = "contactLastName")
    private String contactLastName;
    @Basic
    @jakarta.persistence.Column(name = "contactFirstName")
    private String contactFirstName;
    @Basic
    @jakarta.persistence.Column(name = "phone")
    private String phone;
    @Basic
    @jakarta.persistence.Column(name = "addressLine1")
    private String addressLine1;
    @Basic
    @jakarta.persistence.Column(name = "addressLine2")
    private String addressLine2;
    @Basic
    @jakarta.persistence.Column(name = "city")
    private String city;
    @Basic
    @jakarta.persistence.Column(name = "state")
    private String state;
    @Basic
    @jakarta.persistence.Column(name = "postalCode")
    private String zipCode;
    @Basic
    @jakarta.persistence.Column(name = "country")
    private String country;
    @Basic
    @jakarta.persistence.Column(name = "salesRepEmployeeNumber")
