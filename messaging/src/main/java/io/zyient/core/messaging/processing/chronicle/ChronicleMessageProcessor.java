...
public abstract class ChronicleMessageProcessor<K, E extends Enum<?>, O extends Offset, M>
        extends MessageProcessor<K, M, E, O, ChronicleOffset> {
    protected ChronicleMessageProcessor(@NonNull Class<? extends ProcessingState<E, O>> stateType,
