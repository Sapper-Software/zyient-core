...
public abstract class BaseAzureMessageProcessor<E extends Enum<?>, O extends Offset, M>
        extends AzureMessageProcessor<String, E, O, M> {
    protected BaseAzureMessageProcessor(@NonNull Class<? extends ProcessingState<E, O>> stateType,
