...
import io.zyient.core.messaging.kafka.KafkaOffset;
...
public abstract class KafkaMessageProcessor<K, E extends Enum<?>, O extends Offset, M>
        extends MessageProcessor<K, M, E, O, KafkaOffset> {
