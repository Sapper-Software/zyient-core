...
public class AwsSQSStateManager extends OffsetStateManager<AwsSQSOffset> {
    ...
    public AwsSQSConsumerState get(@NonNull String queue) throws StateManagerError {
        Preconditions.checkArgument(!Strings.isNullOrEmpty(queue));
        return get(AwsSQSConsumerState.OFFSET_TYPE, queue, AwsSQSConsumerState.class);
    }
    ...
    public AwsSQSConsumerState update(@NonNull AwsSQSConsumerState state) throws StateManagerError {
