...
public class MongoContentCursor<E extends Enum<?>, K extends IKey> extends MongoDbCursor<DocumentId, Document<E, K>>
        implements ContentCursor<E, K> {
    private boolean download;
    private final FileSystem fileSystem;

    public MongoContentCursor(@NonNull MongoDbCursor<DocumentId, Document<E, K>> cursor,
