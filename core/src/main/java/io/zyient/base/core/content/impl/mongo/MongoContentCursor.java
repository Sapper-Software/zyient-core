...
public class MongoContentCursor<E extends DocumentState<?>, K extends IKey, D extends Document<E, K, D>> extends MongoDbCursor<DocumentId, Document<E, K, D>>
        implements ContentCursor<E, K, D> {
    private boolean download;
    private final FileSystem fileSystem;

    public MongoContentCursor(@NonNull MongoDbCursor<DocumentId, Document<E, K, D>> cursor,
